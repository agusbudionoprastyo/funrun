...
<body>
    ...
    button.addEventListener('click', function() {
        ...
        // Tulis konten HTML ke dalam iframe setelah semua gambar dimuat
        var iframeDoc = iframe.contentWindow.document;
        var htmlContent = `
            <!DOCTYPE html>
            <html lang="en">
            ...
            <body>
                ...
                <script>
                    // Fungsi untuk memanggil pencetakan setelah semua gambar selesai dimuat
                    function printContent() {
                        window.focus(); // Fokuskan jendela utama untuk memastikan pencetakan berhasil
                        window.print(); // Memicu pencetakan
                    }
                    // Pemanggilan fungsi printContent setelah jendela dimuat sepenuhnya
